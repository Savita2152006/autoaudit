        ...
        <div className="flex flex-col h-full">
          <div className="p-6">
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-white tracking-tight">AutoAudit</span>
            </Link>
          </div>

          <nav className="flex-1 px-4 py-4 space-y-1">
            <div className="px-4 py-2 text-xs font-semibold uppercase tracking-wider text-slate-500">Compliance</div>
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <item.icon className={cn("w-4 h-4", active ? "text-blue-400" : "text-slate-500 group-hover:text-white")} />
          ...
          <div className="p-4 mt-auto">
            <div className="bg-slate-800 rounded-xl p-4">
              <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold mb-2">Audit Engine v4.2.0</p>
              <div className="h-1 w-full bg-slate-700 rounded-full overflow-hidden">
                <div className="h-1 w-3/4 bg-blue-500 rounded-full" />
              </div>
              <p className="text-[10px] text-slate-500 mt-2">Real-time monitoring active</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <header className="h-16 border-b border-slate-200 bg-white sticky top-0 z-30 px-6 flex items-center justify-between">
      <div className="flex items-center gap-4">
        ...
        <div className="hidden lg:flex items-center gap-2 text-sm text-slate-500">
          <span className="hover:text-slate-800 cursor-pointer font-medium">Compliance</span>
          <span className="text-slate-300">/</span>
          <span className="text-slate-900 font-semibold italic serif underline decoration-blue-500/30 underline-offset-4">Audit Workflow</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-6">
        <div className="hidden sm:flex items-center bg-green-50 border border-green-200 px-3 py-1 rounded-full">
          ...
          <span className="text-[10px] font-bold text-green-700 uppercase tracking-tight">System Health: Optimal</span>
        </div>

        <div className="flex items-center gap-4 border-l border-slate-200 pl-6 ml-2">
          <div className="text-right hidden sm:block">
            <p className="text-xs font-bold text-slate-900 leading-none mb-1">Ragul K.</p>
            <p className="text-[10px] text-slate-500 uppercase tracking-widest font-semibold">Chief Compliance Officer</p>
          </div>
